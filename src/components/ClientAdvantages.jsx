export default function ClientAdvantages() {
  const vantagens = [
    ...
    },
    {
      ...
      description:
        "Quanto mais Embarques realizados, mais voc√™ pode ganhar! Acumule embarques e desbloqueie B√¥nus em dinheiro na plataforma.",
      icon: "ÌæÅ",
    },
    {
      title: "Indique e Ganhe",
      description:
        "Indique a plataforma para Embarcadores, Transportadores e at√© para Mudan√ßas. Quando eles concretizarem algum transportes via seus links, voc√™ ganha um b√¥nus em dinheiro!",
      icon: "Ì±•",
    },
  ];
  ...
  return (
    <section className="bg-[#0f172a] text-white py-16 px-6">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-3xl font-bold mb-4 text-green-400">Vantagens para Cliente/Embarcador</h2>
